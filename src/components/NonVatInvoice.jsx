      ...
      <View style={nonVatStyles.invoiceContainer}>
        ...
        <View style={nonVatStyles.termsConditions}>
          ...
          <View style={{ paddingLeft: 10 }}>
            <Text>
              1. THE TERMS AND CONDITIONS OF THIS SALE ARE AS FOLLOWS: 2. THE
              PRICES HEREIN ARE BASED ON CASH PAYMENT. 3. THIS INVOICE IS NOT
              VALID FOR CLAIMING INPUT TAX. P.D. OFFICE, CLARK FIELD, PAMPANGA.
            </Text>
            <Text>
              4. ALL ITEMS DELIVERED ARE CONDITIONAL SUBJECT TO AUTHORIZATION OF
              THE BUYER REPRESENTATIVE. INSPECTION PLATE BE MADE TO THE SELLER
              NOT LATER THAN 24 HOURS FROM RECEIPT/DELIVERY OF GOODS.
            </Text>
            <Text>
              5. TITLE TO THE GOODS WILL ONLY BE TRANSFERRED TO THE BUYER UPON
            ...
            <Text>
              6. WARRANTY PERIOD STARTS FROM THE DATE OF DELIVERY. THE COST OF
              REPAIR/REPLACEMENT UNDER WARRANTY MUST BE SHOULDERED BY THE BUYER.
              7. ATTORNEYS FEE OF NOT LESS THAN ONE-FIFTH OF THE TOTAL AMOUNT
              DUE SHALL BE PAID BY THE LOSING PARTY IN THE EVENT A COURT ACTION
              IS FILED BETWEEN THE PARTIES HERETO.
            </Text>
            <Text>
              8. NO DELIVERY, INSTALLATION, REFUND FOR CANCELLATION OF ORDERS
              MAY BE DONE WITHOUT THE PRIOR WRITTEN CONSENT OF THE SELLER. 9.
              RECEIPT OF THE GOOD(S) COVERED BY THIS ORDER CONSTITUTES
              ACCEPTANCE OF THE GOODS EVEN THOUGH DESCRIPTION OR OTHER
              PARTICULARS OF THE GOODS DELIVERED MAY BE DIFFERENT FROM THOSE
              ORDERED.
            </Text>
            <Text>
              10. ALL CLAIMS FOR DEFECTIVE UNITS MUST BE MADE WITHIN 7 DAYS FROM
              RECEIPT OF GOODS. 11. ALL CASH DISCOUNT OR SPECIAL ARRANGEMENT
              WILL BE MADE INTO THE CONSIDERATION OF THE SELLER - ICS ICT
